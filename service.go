...
const (
	launchdStdoutPath  = "/var/log/wh-dns.stdout.log"
	launchdStderrPath  = "/var/log/wh-dns.stderr.log"
	serviceName        = "wh-dns"
	serviceDisplayName = "WhiteHat DNS service"
	serviceDescription = "WhiteHat DNS: Network-level blocker"
)
...
WhiteHat DNS is successfully installed and will automatically start on boot.
