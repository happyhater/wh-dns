...
const (
	safeBrowsingBlockHost = "standard-block.dns.whitehat.ro"
	parentalBlockHost     = "family-block.dns.whitehat.ro"
)
...
// FilteringConfig represents the DNS filtering configuration
...
func (s *Server) genSOA(request *dns.Msg) []dns.RR {
	...
	soa := dns.SOA{
		...
		Minttl:  86400,
		// copied from DNS
		Ns:     "fake-for-negative-caching.whitehat.ro.",
		Serial: 100500,
